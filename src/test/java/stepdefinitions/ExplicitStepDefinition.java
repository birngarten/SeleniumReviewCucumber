...
public class ExplicitStepDefinition {
    ...
    @Then("kullanici delete webelemntini gorur")
    public void kullanici_delete_webelemntini_gorur() {
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(),30);
        WebElement yeniElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@onclick='deleteElement()']")));
        System.out.println(yeniElement.getText());
        Assert.assertTrue(yeniElement.getText().contains("Delete"));
